  ...
  return (
    <div className="max-w-4xl mx-auto mt-6">
      ...
      <div className="flex gap-2 mb-4">
        <button className={`px-4 py-2 rounded ${tab==='jobs' ? 'bg-blue-600 text-white' : 'bg-gray-100'}`} onClick={()=>setTab('jobs')}>Jobs</button>
        <button className={`px-4 py-2 rounded ${tab==='analytics' ? 'bg-blue-600 text-white' : 'bg-gray-100'}`} onClick={()=>setTab('analytics')}>Analytics</button>
      </div>

      {tab === 'analytics' && smsStats && (
